...
int main()
{
    ...
    if (conectar) {
        ...
        do {
            ...
            {
                int op7;
                string insert7, po, idventa, idventa2, factura, factura2, serie, serie2, fechav, fechav2, fechav3, fechav4, idcliente, idcliente2, idempleado, idempleado2, idproducto, idproducto2, cantidad, cantidad2, precioV, precioV2, consulta7, actualizar7, eliminar7;
                const char* g;
                const char* gg;
                cout << "1. crear" << endl;
                cout << "2. Leer" << endl;
                ...
                switch (op7) {
                case 1:
                    cout << "Datos de la tabla Productos" << endl;
                    consulta7 = "select * from super_mercado.productos";
                    gg = consulta7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                        while (fila = mysql_fetch_row(resultado)) {
                            cout << fila[0] << "," << fila[1] << "," << fila[2] << "," << fila[3] << "," << fila[4] << "," << fila[5] << "," << fila[6] << "," << fila[7] << "," << fila[8] << endl;
                    ...
                    cout << "Datos de la tabla clientes" << endl;

                    consulta7 = "select * from super_mercado.clientes";
                    gg = consulta7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                    ...
                    cout << "------------------------------------------------------------------------------" << endl;
                    cout << "Datos de la tabla empleados" << endl;

                    consulta7 = "select * from super_mercado.empleados";
                    gg = consulta7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                    ...
                    cout << "------------------------------------------------------------------------------" << endl;
                    cout << "Ingrese el no de la factura: ";
                    cin >> factura;
                    ...
                    cin >> precioV;
                    "select *  from ventas;";
                    idventa = "select last_insert_id()+1;";
                    insert7 = "insert into ventas(nofactura,serie,fechafactura,idcliente,idempleado,fechaingreso) values('" + factura + "','" + serie + "','" + fechav + "','" + idcliente + "','" + idempleado + "','" + fechav2 + "');";
                    insert7 = "insert into ventas_detalle(idVenta,idProducto,cantidad,precio_unitario) values('" + idventa + "','" + idproducto + "','" + cantidad + "','" + precioV + "');";
                    g = insert7.c_str();
                    q_estado = mysql_query(conectar, g);
                    if (!q_estado) {
                        cout << "Ingreso exitoso" << endl;
                        cout << "\n";
                    }
                ...
                case 2:
                    consulta7 = "select * from ventas cross join ventas_detalle;";
                    gg = consulta7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                ...
                case 3:
                    cout << "Datos de la tabla Ventas y ventas detalle" << endl;
                    consulta7 = "select * from ventas cross join ventas_detalle;";
                    gg = consulta7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                    ...
                    cin >> precioV2;
                    "select *  from ventas;";
                    idventa = "select last_insert_id();";
                    insert7 = "update ventas set nofactura = '" + factura2 + "',serie = '" + serie2 + "',fechafactura = '" + fechav3 + "',idcliente = '" + idcliente2 + "',idempleado = '" + idempleado2 + "',fechaingreso = '" + fechav4 + "' where idventa= " + actualizar7 + "";
                    insert7 = "update ventas set idProducto = '" + idproducto2 + "',cantidad = '" + cantidad2 + "',precio_unitario = '" + precioV2 + "' where idVenta= " + actualizar7 + "";
                    gg = insert7.c_str();
                    q_estado = mysql_query(conectar, gg);
                    if (!q_estado) {
                        cout << "Ingreso exitoso" << endl;
            ...
            {
                int op8;
                string insert8, idcompra, orden, orden2, idproveedor, idproveedor2, fecha, fecha2, fecha3, fecha4, idproducto, idproducto2, cantidad, cantidad2, precioC, precioC2, consulta8, actualizar8, eliminar8;
                const char* h;
                const char* hh;
                cout << "1. crear" << endl;
                cout << "2. Leer" << endl;
                ...
                switch (op8) {
                case 1:
                    cout << "Datos de la tabla proveedores" << endl;
                    consulta8 = "select * from super_mercado.productos";
                    hh = consulta8.c_str();
                    q_estado = mysql_query(conectar, hh);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                        while (fila = mysql_fetch_row(resultado)) {
                            cout << fila[0] << "," << fila[1] << "," << fila[2] << "," << fila[3] << "," << fila[4] << "," << fila[5] << "," << fila[6] << "," << fila[7] << "," << fila[8] << endl;
                    ...
                    cout << "------------------------------------------------------------------------------" << endl;
                    cout << "Ingrese el no de la orden de compra: ";
                    cin >> orden;
                    cout << "Ingrese el id del proveedor: ";
                    cin >> idproveedor;
                    cout << "Ingrese la fecha de en la que se emitio la orden: ";
                    cin >> fecha;
                    cout << "Ingrese la fecha de ingreso: ";
                    cin >> fecha2;
                    cout << "Ingrese el id del producto: ";
                    ...
                    cin >> cantidad;
                    cout << "Ingrese el precio del costo unitario: ";
                    cin >> precioC;
                    "select *  from compras;";
                    idcompra = "select last_insert_id()+1;";
                    insert8 = "insert into compras(no_orden_compra,idproveedor,fecha_orden,fechaingreso) values('" + orden + "','" + idproveedor + "','" + fecha + "','" + fecha2 + "');";
                    insert8 = "insert into compras_detalle(idcompra,idproducto,cantidad,precio_costo_unitario) values('" + idcompra + "','" + idproducto + "','" + cantidad + "','" + precioC + "');";
                    h = insert8.c_str();
                    q_estado = mysql_query(conectar, h);
                    if (!q_estado) {
                        cout << "Ingreso exitoso" << endl;
                        cout << "\n";
                    }
                ...
                case 2:
                    consulta8 = "select * from compras cross join compras_detalle;";
                    hh = consulta8.c_str();
                    q_estado = mysql_query(conectar, hh);
                    if (!q_estado) {
                        resultado = mysql_store_result(conectar);
                ...
                case 3:
                    cout << "Datos de la tabla compras y compras detalle" << endl;
                    consulta8 = "select * from compras cross join compras_detalle;";
                    hh = consulta8.c_str();
                    q_estado = mysql_query(conectar, hh);
                    if (!q_estado) {
                    ...
                    cin >> precioC2;
                    "select *  from compras;";
                    idcompra = "select last_insert_id();";
                    insert8 = "update compras set no_orden_compra = '" + orden2 + "',idproveedor = '" + idproveedor2 + "',fecha_orden = '" + fecha3 + "',fechaingreso = '" + fecha4 + "' where idcompra= " + actualizar8 + "";
                    insert8 = "update compras_detalle set idproducto = '" + idproducto2 + "',cantidad = '" + cantidad2 + "',precio_costo_unitario = '" + precioC2 + "' where idcompra= " + actualizar8 + "";                    
                    hh = insert8.c_str();
                    q_estado = mysql_query(conectar, hh);
                    if (!q_estado) {
                        cout << "Ingreso exitoso" << endl;
